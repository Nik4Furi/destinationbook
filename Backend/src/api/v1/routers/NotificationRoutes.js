...
Routers.post('/add',FetchUser,NotificationControllers().add); // Adding a new notification, using POST '/api/v1/notification/add
...
Routers.get('/read',FetchUser,NotificationControllers().read); //Reading all unread notifications, using GET '/api/v1/notification/read
