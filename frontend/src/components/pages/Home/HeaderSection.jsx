        ...
        <div className=''>
          ...
          <div className="background-container relative text-start">
            {/* <div className="text-overlay">
              ...
              <a href="#Explore"> <button className="btn-primary px-4 py-2 block my-2 mx-auto w-full text-xl">Explore Now!</button></a>
            ...
            <div className="text-overlay ">
              ...
              <div className="flex items-center justify-evenly my-3">
                ...
                <button className="btn-secondary mx-2">Conference Rooms</button>
